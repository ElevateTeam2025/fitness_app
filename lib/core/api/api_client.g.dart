...
class _ApiClient implements ApiClient {
  ...
  Future<SignInDTO> signIn(SignInRequest data) async {
    ...
    final _options = _setStreamType<SignInDTO>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
    ...
    late SignInDTO _value;
    try {
      _value = SignInDTO.fromJson(_result.data!);
    } on Object catch (e, s) {
  ...
  @override
  Future<void> createNewPassword(CreateNewPasswordrequset request) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
  ...
  Future<MealCategoriesModel> getMealsCategories() async {
    ...
    final _options = _setStreamType<MealCategoriesModel>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
  ...
  @override
  Future<MusclesTabResponseModel> getMusclesTabs() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<MusclesTabResponseModel>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late MusclesTabResponseModel _value;
    try {
      _value = MusclesTabResponseModel.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  @override
  Future<MusclesDataResponseModel> getMusclesData(String id) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<MusclesDataResponseModel>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late MusclesDataResponseModel _value;
    try {
      _value = MusclesDataResponseModel.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  Future<ExerciseResponseDTO> getExercisesByMuscleAndDifficulty(
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<ExerciseResponseDTO>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
  ...
  Future<LevelsResponseDTO> getLevels() async {
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<LevelsResponseDTO>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
