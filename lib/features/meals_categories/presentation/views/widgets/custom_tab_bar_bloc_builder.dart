...
class CustomTabBarBlocBuilder extends StatefulWidget {
  const CustomTabBarBlocBuilder({
    super.key,
    required this.viewModel,
    required this.getMealsByCategoryViewModel,
  });
  final viewModel;
  final getMealsByCategoryViewModel;
  @override
              ...
              itemBuilder: (context, index) {
                ...
                return GestureDetector(
                  onTap: () => setState(() {
                    ...
                    widget.getMealsByCategoryViewModel.doIntents(
                      OnClickGetMealsByCategoryIntent(),
                      category: widget.viewModel.categories[index].strCategory!,
                    );
                  }),
