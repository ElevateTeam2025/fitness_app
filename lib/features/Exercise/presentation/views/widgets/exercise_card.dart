...
class ExerciseCard extends StatelessWidget {
  ...
  final VoidCallback? onTapOverride;  // for testing

  const ExerciseCard({super.key, required this.exercise,this.onTapOverride});
...
// class ExerciseCardd extends StatelessWidget {
//   final Exercises exercise;
//   final VoidCallback? onTapOverride;  // خاصية اختيارية لتجاوز الضغط (للاختبار)
//
//   const ExerciseCardd({
//     Key? key,
...
//           height: responsiveHeight(70),
//           fit: BoxFit.cover,
//           imageErrorBuilder: (_, __, ___) => const Icon(Icons.broken_image, size: 60),
//         ),
//       ),
//       title: Text(
//         exercise.exercise ?? '',
